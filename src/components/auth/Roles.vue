            ...
            <el-row style="border-bottom:1px solid #eee"
              ...
              <el-col :span="20">
                ...
                <el-row :style="{'border-top':i===0?'none':'1px solid #eee'}"
                        ...
                        :key="secondItem.id">
                  <el-col :span="8">
                    <el-tag @close="delRights(scope.row,secondItem.id)"
                            closable
                            type="success">{{secondItem.authName}}</el-tag>
                    <span class="el-icon-caret-right"></span>
                  </el-col>
                  <el-col :span="16">
                    <!--三级权限-->
                    <el-tag @close="delRights(scope.row,lastItem.id)"
