        ...
        <el-table-column label="操作">
          ...
          <template>
            ...
            <el-button icon="el-icon-location"
                       @click="wlDialogFormVisible = true"
                       circle></el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog title="编辑订单"
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="editDialogFormVisible = false">确 定</el-button>
      </div>
    </el-dialog>
    <el-dialog title="查询物理"
               width="400px"
               :visible.sync="wlDialogFormVisible">
      <!--时间线-->
      <el-timeline>
        <el-timeline-item v-for="(item, i) in wlList"
                          :key="i"
                          :timestamp="item.time">
          {{item.context}}
        </el-timeline-item>
      ...
      <div slot="footer"
        ...
        <el-button type="primary"
                   @click="wlDialogFormVisible = false">确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
